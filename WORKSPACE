...
http_archive(
    ...
    url = "https://github.com/google-parfait/federated-language/archive/refs/heads/cl/698046347.tar.gz",
    patches = [
        "//third_party/federated_language:proto_library.patch",
    ],
    strip_prefix = "federated-language-cl-698046347",
    repo_mapping = {
