...
http_archive(
    ...
    sha256 = "b9da4d88794b1e30282494814035719aaf2814a9172c0ed38db2bfb1a23b5277",
    strip_prefix = "federated-language-0.2.0",
    url = "https://github.com/google-parfait/federated-language/archive/refs/tags/v0.2.0.tar.gz",
)
