...
class AnonymousTupleTest(absltest.TestCase):
  ...
  def test_equality_unnamed(self):
    foo = anonymous_tuple.AnonymousTuple([(None, 1), (None, 2)])
    foo_eq = anonymous_tuple.AnonymousTuple([(None, 1), (None, 2)])
    foo_ne_order = anonymous_tuple.AnonymousTuple([(None, 2), (None, 1)])
    foo_ne_name = anonymous_tuple.AnonymousTuple([('a', 1), ('b', 2)])
    foo_ne_value = anonymous_tuple.AnonymousTuple([(None, 10), (None, 10)])
    ...
    self.assertTrue(foo.__eq__(foo_ne_name))
    self.assertTrue(foo_ne_name.__eq__(foo))
    self.assertTrue(foo.__ne__(foo_ne_value))
    self.assertTrue(foo_ne_value.__ne__(foo))

  def test_equality_named(self):
    foo = anonymous_tuple.AnonymousTuple([('a', 1), ('b', 2)])
    foo_eq = anonymous_tuple.AnonymousTuple([('a', 1), ('b', 2)])
    foo_ne_order = anonymous_tuple.AnonymousTuple([('b', 2), ('a', 1)])
    foo_ne_name = anonymous_tuple.AnonymousTuple([('c', 1), ('d', 2)])
    foo_ne_value = anonymous_tuple.AnonymousTuple([('a', 10), ('b', 10)])
    self.assertTrue(foo.__eq__(foo))
    self.assertEqual(foo.__eq__(1), NotImplemented)
    self.assertTrue(foo.__eq__(foo_eq))
    self.assertTrue(foo_eq.__eq__(foo))
