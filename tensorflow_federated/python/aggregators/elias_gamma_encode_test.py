...
_test_value_type_list_int32_tensors = [(tf.int32, (2,)), (tf.int32, (3,))]

_test_client_values_int32_tensor_rank_1 = [[-5, 3, 0, 0], [-3, 1, 0, 0]]
_test_client_values_int32_tensor_rank_2 = [[[-5, 3, 0, 0], [-3, 1, 0, 0]],
                                           [[-5, 3, 0, 0], [-3, 1, 0, 0]]]

_test_avg_bitstring_len_int32_tensor_rank_1 = 16
_test_avg_bitstring_len_int32_tensor_rank_2 = 32
...
class EncodeComputationTest(test_case.TestCase, parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ...
      ('list_int32_tensors', _test_value_type_list_int32_tensors))
...
class EncodeExecutionTest(test_case.TestCase, parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      ('int32_tensor_rank_1', _test_value_type_int32_tensor_rank_1,
       ...
       _test_avg_bitstring_len_int32_tensor_rank_1),
      ('int32_tensor_rank_2', _test_value_type_int32_tensor_rank_2,
       _test_client_values_int32_tensor_rank_2,
       _test_avg_bitstring_len_int32_tensor_rank_2))
  def test_encode_impl(self, value_type, client_values, avg_bitstring_length):
    ...
    expected_measurements = collections.OrderedDict(
        elias_gamma_code_avg_bitrate=avg_bitstring_length /
