...
"""Simple examples implementing the Model interface for integration testing."""
...
class LinearRegression(tff.learning.Model):
  ...
  def forward_pass(self,
                   batch_input,
                   training=True) -> tff.learning.BatchOutput:
  ...
  @property
  def federated_output_computation(self) -> tff.Computation:
