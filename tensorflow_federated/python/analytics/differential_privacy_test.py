...
class DifferentialPrivacyTest(parameterized.TestCase):
  ...
  @parameterized.named_parameters(
      {
          'testcase_name': 'epsilon_0',
          'epsilon': 0.0,
          'regex': 'epsilon'
      },
      {
          'testcase_name': 'epsilon_neg',
          'epsilon': -1.0,
          'regex': 'epsilon'
      },
      {
          'testcase_name': 'epsilon_large',
          'epsilon': 600,
          'regex': 'epsilon'
      },
      {
          'testcase_name': 'delta_0',
          'delta': 0.0,
          'regex': 'delta'
      },
      {
          'testcase_name': 'delta_1',
          'delta': 1.0,
          'regex': 'delta'
      },
      {
          'testcase_name': 'delta_neg',
          'delta': -1.0,
          'regex': 'delta'
      },
      {
          'testcase_name': 'delta_large',
          'delta': 10.0,
          'regex': 'delta'
      },
      {
      ...
      {
          'testcase_name': 'tol_neg',
          'tol': -1.0,
          'regex': 'tol'
      },
  )
  def test_analytic_gauss_stddev_input_validation(self,
                                                  epsilon=1.0,
                                                  delta=0.1,
                                                  norm_bound=1.0,
                                                  tol=1.e-12,
  ...
  def test_analytic_gauss_stddev_as_expected(self, epsilon, delta, norm_bound,
                                             expected_stddev):
