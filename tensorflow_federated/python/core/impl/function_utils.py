    ...
    if unpack:
      ...
      def _unpack_and_call(fn, arg_types, kwarg_types, arg):
        ...
        for idx, expected_type in enumerate(arg_types):
          ...
          if (isinstance(arg, anonymous_tuple.AnonymousTuple) and
      ...
      def _call(fn, parameter_type, arg):
        ...
        if (isinstance(arg, anonymous_tuple.AnonymousTuple) and isinstance(
            arg_type, computation_types.NamedTupleTypeWithPyContainerType)):
