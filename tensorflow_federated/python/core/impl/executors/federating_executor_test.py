...
class FederatingExecutorCreateValueTest(executor_test_utils.AsyncTestCase,
  ...
  def test_returns_value_with_value_and_type(self, value, type_signature):
    ...
    self.assertIsInstance(result, executor._strategy.value_type)
...
#     })
#     executor = default_federating_strategy.FederatingExecutor(
#         strategy, eager_tf_executor.EagerTFExecutor())
...
#         placement_literals.CLIENTS: eager_tf_executor.EagerTFExecutor(),
#     })
#     executor = federating_executor.FederatingExecutor(strategy, None)
