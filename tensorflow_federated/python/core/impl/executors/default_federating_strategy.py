...
class FederatingStrategyValue(executor_value_base.ExecutorValue):
  """A value embedded in a `FederatedExecutor`."""

  def __init__(self, value, type_signature):
    """Creates a `FederatingStrategyValue` embedding the given `value`.
  ...
  async def compute(self):
    ...
    if isinstance(self._value, executor_value_base.ExecutorValue):
      ...
      results = await asyncio.gather(*[
          FederatingStrategyValue(v, t).compute()
...
class DefaultFederatingStrategy(federating_executor.FederatingStrategy):
  ...
  * `tff.CLIENTS`
  ...
  def __init__(self, executor, target_executors):
    """Creates a `DefaultFederatingStrategy`.
    ...
    Raises:
      ...
      ValueError: If `target_executors` contains a
        ...
        by the `DefaultFederatingStrategy`.
    """
  ...
  @property
  def value_type(self):
    return FederatingStrategyValue
  ...
  async def create_federated_value(self, value, type_spec):
    ...
    return FederatingStrategyValue(result, type_spec)
  ...
  async def create_federated_aggregate(self, arg):
    ...
    pre_report = await self.create_federated_reduce(
        FederatingStrategyValue(
    ...
    return await self.create_federated_apply(
        FederatingStrategyValue(
            anonymous_tuple.AnonymousTuple([
  ...
  async def create_federated_mean(self, arg):
    arg_sum = await self.create_federated_sum(arg)
    ...
    return FederatingStrategyValue([result], arg_sum.type_signature)
  ...
  async def create_federated_reduce(self, arg):
    ...
    return FederatingStrategyValue([result],
                                   computation_types.FederatedType(
  ...
  async def create_federated_sum(self, arg):
    ...
    zero, plus = await asyncio.gather(
        ...
        executor_utils.embed_tf_binary_operator(self._executor,
                                                ...
                                                tf.add))
    return await self.create_federated_reduce(
        FederatingStrategyValue(
            anonymous_tuple.AnonymousTuple([
