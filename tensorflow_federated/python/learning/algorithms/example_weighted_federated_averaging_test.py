...
from tensorflow_federated.python.learning.algorithms import example_weighted_federated_averaging as fed_avg
...
class FedAvgTest(test_case.TestCase, parameterized.TestCase):
  ...
  def test_construction_calls_model_fn(self, optimizer_fn, aggregation_factory):
    ...
    fed_avg.build_example_weighted_federated_averaging_process(
