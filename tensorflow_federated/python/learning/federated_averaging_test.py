...
class FederatedAveragingClientWithTrainableModelTest(test.TestCase,
                                                     parameterized.TestCase):
  """Tests of _DeprecatedClientFedAvg that use a common model and data."""
...
# TODO(b/148576550): remove as part of tff.learning.TrainableModel deprecation.
# Remove after all users have migrated.
class FederatedAveragingTrainableModelTffTest(test.TestCase,
                                              parameterized.TestCase):
