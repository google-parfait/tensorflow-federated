...
class NumExamplesCounter(tf.keras.metrics.Sum):
  ...
  def update_state(self, y_true, y_pred=None, sample_weight=None):  # pyrefly: ignore[bad-override]
    del y_pred, sample_weight  # Unused
...
class NumBatchesCounter(tf.keras.metrics.Sum):
  ...
  def update_state(self, y_true, y_pred=None, sample_weight=None):  # pyrefly: ignore[bad-override]
    del y_true, y_pred, sample_weight  # Unused.
