...
// Cannot merge with a non-DPQuantileAggregator.
TEST(DPQuantileAggregatorTest, MergeWithNonDPQuantileAggregator) {}

// Cannot merge with a DPQuantileAggregator with a different target quantile.
TEST(DPQuantileAggregatorTest, MergeWithDifferentTargetQuantile) {}

// Successful merge should increase buffer size correctly.
TEST(DPQuantileAggregatorTest, MergeWithSuccessful) {}
