...
TEST(DPOpenDomainHistogramTest, Deserialize_FailToParseProto) {
  // Prefix of state does not correspond to a valid length.
  ...
  // Suffix of state does not correspond to a valid proto.
  ...
  std::string invalid_state2 =
      absl::StrCat(padding_length_bytes, "invalid_state");
