...
template <typename InputType1, typename InputType2 = InputType1>
StatusOr<OutputTensorList> DoubleKeyDoubleAgg(
    ...
    std::initializer_list<InputType1> value_list1,
    std::initializer_list<InputType2> value_list2, bool serialize_deserialize) {
  TFF_ASSIGN_OR_RETURN(auto aggregator, CreateTensorAggregator(intrinsic));
  TFF_ASSIGN_OR_RETURN(
      Tensor keys1,
  ...
  TFF_ASSIGN_OR_RETURN(
      Tensor value_tensor1,
      Tensor::Create(internal::TypeTraits<InputType1>::kDataType, shape,
                     CreateTestData<InputType1>(value_list1)));
  TFF_ASSIGN_OR_RETURN(
      Tensor value_tensor2,
      Tensor::Create(internal::TypeTraits<InputType2>::kDataType, shape,
                     CreateTestData<InputType2>(value_list2)));
  auto acc_status =
