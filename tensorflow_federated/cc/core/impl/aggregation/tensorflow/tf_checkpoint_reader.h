...
// Vendored copy of tensorflow/c/checkpoint_reader.h.
// This file is not shipped with the TensorFlow pip package, but all of its
// transitive dependencies are. This copy allows TFF to compile against the
// pip package headers.
