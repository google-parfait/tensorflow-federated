...
#ifndef THIRD_PARTY_TENSORFLOW_FEDERATED_CC_TESTING_PROTOBUF_MATCHERS_H_
#define THIRD_PARTY_TENSORFLOW_FEDERATED_CC_TESTING_PROTOBUF_MATCHERS_H_
...
class ProtoMatcher : public ProtoMatcherBase {
 ...
 private:
  ...
  ExpectedProtoPtr CreateExpectedProto(
      const google::protobuf::Message&, ::testing::MatchResultListener*) const override {
...
#endif  // THIRD_PARTY_TENSORFLOW_FEDERATED_CC_TESTING_PROTOBUF_MATCHERS_H_
